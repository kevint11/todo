...
export default function Home() {
  ...
  const onSubmit = data => {console.log(data['addTodo'])  
  setVals(data['addTodo'])
} 
      ...
      <main>
        ...
        <div className="mb-4">
            ...
            <div className="flex mt-4">
                <input {...register("addTodo", { required: true, maxLength: 20 })} className="shadow appearance-none border rounded w-full py-2 px-3 mr-4 text-grey-darker" placeholder="Add Todo" />
                <input className="flex-no-shrink p-2 border-2 rounded text-teal border-teal hover:text-white hover:bg-teal" type="submit" value="Tambah"/>
            </div>
            </form>
        </div>
        <div>
            <div className="flex mb-4 items-center">
                <p className="w-full text-grey-darkest">{vals}</p>
